package net.prosavage.savagekits.gson;


import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import net.prosavage.savagekits.ChestKits;
import net.prosavage.savagekits.gson.typeadapters.EnumTypeAdapter;
import net.prosavage.savagekits.gson.typeadapters.LocationTypeAdapter;
...
public class Persist {
    ...
    public File getFile(String name) {
        return new File(ChestKits.getInstance().getDataFolder(), name + ".json");
    }
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        if (!file.exists()) {
            ChestKits.getInstance().getLogger().fine("Creating default: " + file);
            this.save(def, file);
            return def;
        }
        ...
        if (loaded == null) {
            ChestKits.getInstance().getLogger().log(Level.WARNING, "Using default as I failed to load: " + file);
            ...
            ChestKits.getInstance().getLogger().log(Level.WARNING, "Backing up copy of bad file to: " + backup);
    ...
    public <T> T load(Class<T> clazz, File file) {
        ...
        try {
            ...
            ChestKits.getInstance().getLogger().log(Level.WARNING, ex.getMessage());
        }
